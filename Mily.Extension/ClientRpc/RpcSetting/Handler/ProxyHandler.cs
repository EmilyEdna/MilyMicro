...
namespace Mily.Extension.ClientRpc.RpcSetting.Handler
{
    ...
    public class ProxyHandler
    {
        ...
        /// <returns></returns>
        public static ResultProvider InitProxy(ResultProvider Provider,Type BaseType)
        {
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        private static ResultProvider EachProxy(ClientKey Key, ResultProvider Provider,Type BaseType)
        {
            return Key.NetType switch
            {
                NetTypeEnum.Connect => null,
                NetTypeEnum.Listened => ClientHandler.Invoke(Provider, BaseType),
